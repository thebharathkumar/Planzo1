...
import { ShoppingCart, Menu, X, Zap, LogOut, UserPlus, UserCircle } from "lucide-react";
      ...
      <div className="flex items-center gap-3">
        ...
        {currentUser ? (
          <div className="flex items-center gap-2 anim-fade-in">
            ...
            <Link to="/profile" className="hidden md:block" style={{ textDecoration: "none" }}>
              <span className="text-xs font-semibold" style={{ color: "#1a0a00" }}>
            ...
            <Link to="/profile" className="hidden md:flex p-1.5 rounded-lg transition-all duration-200 hover:bg-orange-50" title="Profile Settings">
